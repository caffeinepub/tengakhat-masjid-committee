import { c as commonjsGlobal, a as getDefaultExportFromCjs } from "./index-CkAvp7ud.js";
import { _ as _typeof$1 } from "./jspdf.es.min-B7rDgTqx.js";
...
var setGroups = function(re, groups) {
  var object = re.groups = create$2(null);
...
if (PATCH) {
  patchedExec = function exec2(string) {
    ...
    var match2 = call$7(nativeExec, sticky ? reCopy : re, strCopy);
    if (sticky) {
      if (match2) {
        match2.input = str;
    ...
    if (match2 && groups) setGroups(match2, groups);
    return match2;
  };
}
...
var advanceStringIndex$3 = function(S, index2, unicode) {
  return index2 + (unicode ? charAt$1(S, index2).length || 1 : 1);
};
...
var stringIndexOf$3 = uncurryThis$9("".indexOf);
fixRegExpWellKnownSymbolLogic$2("match", function(MATCH2, nativeMatch, maybeCallNative) {
  return [
    ...
    function(string) {
      ...
      var flags = toString$6(getRegExpFlags$3(rx));
...
fixRegExpWellKnownSymbolLogic$1("replace", function(_2, nativeReplace2, maybeCallNative) {
  ...
  return [
    ...
    function(string, replaceValue) {
      ...
      var flags = toString$5(getRegExpFlags$2(rx));
